...
public class RouteController {
    ...
    public void createNewRoute(@RequestParam(name = "startPoint") Long startPoint,
            @RequestParam(name = "endPoint") Long endPoint) {
     ...
     *//*
        * @PostMapping
        * 
        * public void createRoute(@RequestBody RouteAdditionRequest
        ...
        *//*
           * 
           * @GetMapping
           * public ResponseEntity<List<Route>> getAllRoutes(@RequestParam(required =
           * false) Integer startPoint) {
           * try {
           ...
           * 
           * @GetMapping("/{endPoint}}")
           * public ResponseEntity<List<Route>> findByEndPoint(@PathVariable("endPoint")
           * Integer endPoint) {
           * try {
           ...
           *//*
              ...
              * findByStartAndEndPoint(@PathVariable("startPoint") Integer
              * startPoint, @PathVariable("endPoint") Integer endPoint) {
              * try {
              * List<Route> routes =
              * routeRepository.findByEndAndStartPoint(startPoint,endPoint);
              * if (routes.isEmpty()) {
              * return new ResponseEntity<>(HttpStatus.NO_CONTENT);
              * }
              * return new ResponseEntity<>(routes, HttpStatus.OK);
              ...
              *//*
                ...
                *//*
                    * @GetMapping("/points}")
                    * public ResponseEntity<List<Route>> findByPoints(@Param("startPoint")Integer
                    * startPoint, @Param("endPoint") Integer endPoint, @Param("middlePoint")
                    * Integer middlePoint) {
                    * try {
                    * List<Route> routes = routeRepository.findByPoints(startPoint, endPoint,
                    * middlePoint);
                    * if (routes.isEmpty()) {
                    * return new ResponseEntity<>(HttpStatus.NO_CONTENT);
                    * }
                    ...
                    *//*
                       ...
                       * .save(new Route(route.getRouteName(), route.getStartPoint(),
                       * route.getEndPoint(), route.getMiddlePoints(), route.getDistance(),
                       ...
                       * 
                       * @PutMapping("/{id}")
                       * public ResponseEntity<Route> updateRoute(@PathVariable("id") Integer
                       * Id, @RequestBody Route route){
                       * Optional<Route> routeData = routeRepository.findById(Id);
                       * if(routeData.isPresent()){
                       ...
                       * 
                       * @DeleteMapping("/{id}")
                       * public ResponseEntity<HttpStatus> deleteRoute(@PathVariable("id") Integer
                       * Id){
                       * try{
