...
public class RouteService {
    ...
    public void addNewRoute(Long startPoint, Long endPoint) {
        ...
        Double d = calculateDistance(route.getStartPoint().getLatitude(), route.getStartPoint().getLongitude(),
                route.getEndPoint().getLatitude(), route.getEndPoint().getLongitude());
        route.setDistance(d);
    ...
    public void updateRoute(Long routeId, Route updatedRoute) {
        ...
        /*
         * Double d = calculateDistance(updatedRoute.getStartPoint().getLatitude(),
         * updatedRoute.getStartPoint().getLongitude(),
         * updatedRoute.getEndPoint().getLatitude(),
         * updatedRoute.getEndPoint().getLongitude());
         * Double dur = calculateDuration(d);
         */

        if (updatedRoute.getStartPoint() != null
                && !Objects.equals(route.getStartPoint(), updatedRoute.getStartPoint())) {
        ...
        if (updatedRoute.getMiddlePoints() != null
                && !Objects.equals(route.getMiddlePoints(), updatedRoute.getMiddlePoints())) {
            route.setMiddlePoints(updatedRoute.getMiddlePoints());
        }

        if (updatedRoute.getAttractions() != null
                && !Objects.equals(route.getAttractions(), updatedRoute.getAttractions())) {
        ...
        // if(updatedRoute.getDistance() != null && !Objects.equals(route.getDistance(),
        // updatedRoute.getDistance())){
        // route.setDistance(d);
        // }
        //
        // if(updatedRoute.getDuration() != null && !Objects.equals(route.getDuration(),
        // updatedRoute.getDuration())){
    ...
    // nese ka me shume middlepoints me jau llogarite edhe atyne. me shku startpoint
    // middlepoint tani middlepoint endpoint
